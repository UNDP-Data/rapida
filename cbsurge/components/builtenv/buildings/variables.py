...
GMOSM_BUILDINGS_URL = f'/vsicurl/{GMOSM_BUILDINGS_ROOT}/country_iso={{country}}/{{country}}.fgb'

def generate_variables():
    variables = OrderedDict()
    variables['no_buildings'] = dict(title='Number of buildings', source=GMOSM_BUILDINGS_URL,  operator='count', percentage=True)
